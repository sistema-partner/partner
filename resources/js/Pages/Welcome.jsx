...
function FeatureCard({
    ...
    return (
        <Card
            className={`group bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-8 text-center hover:shadow-xl transition-all duration-300 ${borderHover}`}
        >
            <div
            ...
            <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-blue-900">
                ...
                <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                    <div className="text-center mb-16">
                        <Tag className="inline-flex gap-2 px-4 py-2 rounded-full text-sm font-medium mb-6 bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 border-0">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <Link href={route("register")}>
                                <Button
                                    label="Começar Agora"
                                    className="px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold uppercase tracking-widest"
                                />
                            </Link>
                            <Link href={route("login")}>
                                <Button
                                    label="Fazer Login"
                                    className="px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold uppercase tracking-widest p-button-outlined"
                                />
                            </Link>
                        </div>
                    </div>
