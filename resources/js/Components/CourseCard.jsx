...
const CourseCard = ({ course, onDelete, isTeacher = true, viewMode }) => {
    ...
    return (
        <div className="bg-white dark:bg-dark-card rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-200 dark:border-dark-border group overflow-hidden">
            {/* Área clicável - Imagem e conteúdo principal */}
            <Link
                href={route("courses.show", course.id)}
                className="block focus:outline-none focus:ring-2 focus:ring-blue-primary"
            >
                {/* Imagem do curso */}
                ...
                <div className="p-4 min-h-[200px] flex flex-col">
                    ...
                    <p className="text-gray-600 dark:text-dark-muted-foreground group-hover:text-white text-[0.95rem] line-clamp-2 mb-3 transition-colors">
                        {course.description || "Sem descrição disponível"}
                    </p>

                    {/* Metadados */}
                    <div className="flex items-center justify-between text-[0.95rem] text-gray-500 dark:text-dark-muted-foreground group-hover:text-white mb-3 transition-colors">
                    ...
                    {isTeacher && (
                        <div className="flex items-center gap-4 text-[0.9rem] text-gray-500 dark:text-dark-muted-foreground group-hover:text-white mb-3 transition-colors">
                            <div className="flex items-center gap-1">
                    ...
                    {/* Datas */}
                    <div className="flex flex-wrap gap-2 text-[0.9rem] text-gray-500 dark:text-dark-muted-foreground">
                        {course.start_date && (
            ...
            {/* Área NÃO clicável - Ações dos botões */}
